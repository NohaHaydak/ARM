...
u8 RCC_ConfigurePLL(RCC_PLL_ClkSource_t MCopy_clk_Source,u8 MCopy_PLLM_factor,u8 MCopy_PLLP_factor,u16 MCopy_PLLN_factor)
{
	...
	else
	{
		...
		RCC->RCC_PLLCFGR=(RCC->RCC_PLLCFGR &(0xFFFFFFC0))|(u32)MCopy_PLLM_factor;
		/*PLLN*/
		/*masking and assigning value in register*/
		RCC->RCC_PLLCFGR=(RCC->RCC_PLLCFGR &(0xFFFFC01F))|((u32)MCopy_PLLN_factor<<RCC_PLLConfigrationReg_PLLN);
