...
#define PIN_STATUS_GP_OUTPUT_PP     0b00000001
#define PIN_STATUS_GP_OUTPUT_PP_PU  0b00001001
#define PIN_STATUS_GP_OUTPUT_PP_PD  0b00010001
#define PIN_STATUS_RESERVED1        0b00011001
#define PIN_STATUS_GP_OUTPUT_OD     0b00000101
#define PIN_STATUS_GP_OUTPUT_OD_PU  0b00001101
#define PIN_STATUS_GP_OUTPUT_OD_PD  0b00010101
#define PIN_STATUS_RESERVED2        0b00011101

#define PIN_STATUS_AF_OUTPUT_PP     0b00000010
#define PIN_STATUS_AF_OUTPUT_PP_PU  0b00001010
#define PIN_STATUS_AF_OUTPUT_PP_PD  0b00010010
#define PIN_STATUS_RESERVED3        0b00011010
#define PIN_STATUS_AF_OUTPUT_OD     0b00000110
#define PIN_STATUS_AF_OUTPUT_OD_PU  0b00001110
#define PIN_STATUS_AF_OUTPUT_OD_PD  0b00010110
#define PIN_STATUS_RESERVED4        0b00011110

#define PIN_STATUS_INPUT_FLOATING   0b00000000
#define PIN_STATUS_INPUT_PU         0b00001000
#define PIN_STATUS_INPUT_PD         0b00010000
#define PIN_STATUS_RESERVED5        0b00011000

#define PIN_STATUS_ANALOG		    0b00000011
#define PIN_STATUS_RESERVED6        0b00010011
#define PIN_STATUS_RESERVED7        0b00001011
#define PIN_STATUS_RESERVED8        0b00011011
